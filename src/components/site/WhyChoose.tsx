...
const points = [
  {
    title: "Fast Delivery",
    desc: "Working systems shipped in weeks, not months.",
  },
  {
    title: "Cost Effective",
    desc: "Lean automations that pay for themselves quickly.",
  },
  {
    title: "Scalable Systems",
    desc: "Built to grow with your traffic and team.",
  },
  {
    title: "Global Clients",
    desc: "Trusted by founders and teams across the world.",
  },
];
        ...
        <div>
          <Reveal>
            ...
            <p className="mt-4 text-muted-foreground max-w-lg leading-relaxed">
              We blend enterprise-grade engineering with the speed and clarity
              of a startup partner.
            </p>
          </Reveal>
        ...
        <Reveal delay={150} y={32} duration={600}>
          <div className="relative">
            ...
            <div className="relative rounded-2xl bg-gradient-to-br from-muted to-white border border-border p-6 shadow-card animate-float-slow transition-medium hover:shadow-card-hover">
              <img
                src={illus}
                alt="AI automation specialist illustration"
                width={1024}
                height={1024}
                loading="lazy"
